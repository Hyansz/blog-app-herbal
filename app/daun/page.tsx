...
export default function DaunPage() {
    const [search, setSearch] = useState("");

    const daun = herbs.filter(
        (item) =>
            item.category === "daun" &&
    ...
    return (
        <AppLayout search={search} setSearch={setSearch} activeMenu="/daun">
            {/* HERO */}
            ...
            <div className="mb-8 flex items-end justify-between gap-5">
                <div>
                    ...
                    <p className="mt-2 text-[15px] leading-relaxed text-[#5f6f61]">
                        Temukan berbagai tanaman herbal daun pilihan khas
                        nusantara.
                    </p>
                </div>
